...
optimalFolder = path + "/Optimal_Segmentation_Files" #"\\1-Optimal-Segments"  # you may have to specify the complete path
studentFolder = path + "/Student_Segmentation_Files" #"\\1-Our-Segments" # you may have to specify the complete path
...
def main():
	...
	totalScore = 0
	file_names = list(os.listdir(studentFolder))
	for num, student in enumerate(studentFiles):
		highestScore = 0
